...
class Lietcelv:
    def __init__(self):
        ...
        # Create Label in our window
                # Spēles apraksts
        self.text = tk.Label(self.root, text="Spēles apraksts:\n Spēlētājam tiks parādīta bilde, un viņam būs jāizvēlas pareizais burts no dotajām izvēlēm.\n Uz ekrāna tiks parādīta bilde. Zem bildes būs divas pogas ar burtiem.\n Viena poga būs ar pareizo burtu, kas attiecas uz bildē redzamo objektu",font=("Helvetica", 10, "bold"), justify="left")
        self.text.pack(anchor="w", padx=10)

        # Spēles gaita
        self.text = tk.Label(self.root, text="Spēles gaita:\n Spēles sākumā parādīsies pirmā bilde un divas pogas ar burtiem. \n Ja spēlētājs izvēlas pareizo burtu, tas turpina spēli, ja nē, tad mēģina vēlreiz",font=("Helvetica", 10, "bold"), justify="left")
        self.text.pack(anchor="w", padx=10)

        # Bildes un burtu izvēle
        self.text = tk.Label(self.root, text="Bildes un burtu izvēle:\n Bildes ir sagatavotas iepriekš, un tās tiks mainītas, kad spēlētājs izvēlas pareizo pogu.\n Katram burtam ir pievienota attiecīgā bilde, un spēles gaitā tas tiks mainīts.", font=("Helvetica", 10, "bold"), justify="left")
        self.text.pack(anchor="w", padx=10)

        # Svari un cipari
        self.text = tk.Label(self.root, text="Puntku sistēma:\n Spēles laikā tiks reģistrēts cik bieži spēlētājs ir izvēlējies pareizo pogu.", font=("Helvetica", 10, "bold"), justify="left")
        self.text.pack(anchor="w", padx=10)
        
        self.close_button = tk.Button(self.root, text="Sapratu!", command=self.close_window)
        self.close_button.pack(side=tk.RIGHT, padx=10, pady=10, ipadx=100, ipady=30)
        
        self.image_path = "rhink.png"  # Path to your image
...
class ButtonHandler:
    ...
    def incorrect_button_pressed(self):
        ...
        self.try_again_button = tk.Button(self.root, text="Mēģināt vēlreiz", command=self.try_again)
...
images_paths =["arbuzs.png","apple.png","banans.png","citrons.png","cuska.png","dinazaurs.png",
               "egle.png","ezelis.png","flamingo.png","galds.png","gitara.png","heli.png","iesnas.png", "iis.png","jura.png","kakis.png",
               "kirbis.png","lacis.png","launs.png","masina.png","nauda.png","nau.png","ozols.png","pele.png","riepa.png","suns.png",
               "sokolode.png","taurenis.png","uguns.png","udens.png","vavere.png","zabaks.png","zogs.png"]
...
label_text = tk.Label(root, text="Ar kuru burtu sākas šis vārds?")
label_text.pack()
